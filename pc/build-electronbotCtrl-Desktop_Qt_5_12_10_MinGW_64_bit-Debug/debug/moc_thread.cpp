...
#include "../../electronbotCtrl/thread.h"
...
QT_MOC_LITERAL(1, 7, 10), // "sendRecDat"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5) // "BYTE*"

    },
    "Thread\0sendRecDat\0\0BYTE*"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->sendRecDat((*reinterpret_cast< BYTE*(*)>(_a[1])));
        ...
        {
            using _t = int (Thread::*)(BYTE * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::sendRecDat)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
int Thread::sendRecDat(BYTE * _t1)
{
    int _t0{};
