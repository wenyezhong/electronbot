...
void Main()
{
    ...
    //printf("id = %d\r\n",boardConfig.nodeId);
    //int dat=ceil(motor.mechanicalAngleMin);
    //printf("mechanicalAngleMin=%d\r\n",dat);
    //dat=ceil(motor.mechanicalAngleMax);
    //printf("mechanicalAngleMax=%d\r\n",dat);
    //printf("adcValAtAngleMin = %d\r\n",boardConfig.adcValAtAngleMin);
    //printf("adcValAtAngleMax = %d\r\n",boardConfig.adcValAtAngleMax);
    // Start receive data
