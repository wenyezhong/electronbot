...
#define USBD_PRODUCT_STRING_FS Electronbot CDC Interface
#define NATIVE_STRING  Electronbot Native Interface
#define USBD_SERIALNUMBER_STRING_FS     "000000000001"

// #define USBD_PRODUCT_STRING_FS     "electronbot@wenyz"
